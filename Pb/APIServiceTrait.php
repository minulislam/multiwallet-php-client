...
trait APIServiceTrait
{
    final public function getMethods()
    {
        return [
            ...
            "/pb.API/DumpTables" => "doDumpTables",
        ];
    }
    ...
    final public function doDumpTables(\Lv\Grpc\Session $session, $data)
    {
        $request = new \Pb\CoinSelection;
        ...
        return $this->DumpTables($request);
    }
}
